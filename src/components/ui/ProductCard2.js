...
const ProductCard2 = () => {
    ...
    return <>
        ...
        <div className="group my-2 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
            ...
            <div className="mt-4 px-5 pb-5">
                <a href="#">
                    <h5 className="text-xl font-oswald font-semibold  tracking-tight text-slate-900">Nike Air MX Super 2500 - Red</h5>
                </a>
                <div className="mt-2 mb-2 flex items-center justify-between">
                    <p>
                        <span className="text-xl font-bold font-oswald text-slate-900">Rs 449 /- only</span>
                        <span className="text-sm ml-2 font-oswald text-slate-900 line-through">Rs 699 /-</span>
                    </p>
                </div>
                <div className='mb-2'>
